	...
	public async Task PopulateCharacterShop()
{
	...
	public void ShowCharacters()
	{
		...
		// Hat scroller goes off-screen right
		_hatsOffset = new Vector2(Screen.width * 2, HatOptionScroller.anchoredPosition.y);

		// Character scroller stays visible at center
		_charactersOffset = new Vector2(0, CharacterOptionScroller.anchoredPosition.y);
	}
	...
	public void ShowHats()
	{
		...
		// Character scroller goes off-screen left
		_charactersOffset = new Vector2(-Screen.width * 2, CharacterOptionScroller.anchoredPosition.y);

		// Hat scroller stays visible at center
